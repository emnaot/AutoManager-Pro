...
@section('content')
<div id="create-vehicule-app">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">➕ Ajouter un nouveau véhicule</h4>
                </div>
                <div class="card-body">
                    <!-- Messages d'alerte -->
...
createApp({
    ...
    methods: {
        async submitForm() {
            ...
            try {
                const response = await axios.post('/api/vehicules', this.form);
                
                if (response.data.success) {
                    this.showMessage('Véhicule créé avec succès !', 'success');
                ...
                if (error.response && error.response.status === 422) {
                    ...
                    this.showMessage('Erreur lors de la création du véhicule', 'danger');
                }
            } finally {
                this.loading = false;
            }
